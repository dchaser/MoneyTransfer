...
public class StringUtils {
	...
	public static String removeFromCsvIfExists(String key, String csv) {
		...
		if (!containsInArray(key, elements))
			return csv;
	...
	/**
	 * Returns true if a and b are equal ignoring the case of the characters,
	 * including if they are both null.
	 * 
	 * @param a
	...
	/**
	 * Returns true if a and b are equal ignoring the case of the characters,
	 * including if a is null and b is zero length.
	 * 
	 * @param a
	 ...
	 * @param offset
	 *            start offset of array b
	 * @param length
	 *            length of characters in array b
	 * @return {@code true} if a and b are equal, {@code false} otherwise.
	 * @throws IndexOutOfBoundsException
	 *             if
	 *             {@code offset < 0 || length < 0 || offset + length > data.length}
	 *             .
	...
	public static boolean equalsIgnoreCase(CharSequence a, char[] b,
		...
		if (offset < 0 || length < 0 || length > b.length - offset)
			throw new IndexOutOfBoundsException("array.length=" + b.length
	 ...
	 * @return {@code true} if cs contains any upper case characters,
	 ...
	 * 
	 * This method will always keep the first occurrence of all strings at their
	 * position in the array, removing the subsequent ones.
	 */
	...
	public static String toTitleCase(String s, Locale locale) {
		...
		// - This does not work for Greek, because it returns upper case instead
		// of title case.
		// - It does not work for Serbian, because it fails to account for the
		// "lj" character,
		// which should be "Lj" in title case and "LJ" in upper case.
		// - It does not work for Dutch, because it fails to account for the
		// "ij" digraph, which
		// are two different characters but both should be capitalized as "IJ"
		// as if they were
		// a single letter.
	...
	public static int[] toCodePointArray(final String string) {
		...
		final int[] codePoints = new int[Character.codePointCount(characters,
				0, length)];
